    ...
    <div class="">
        ...
        <div class="mb-20">
            <main class="grid grid-cols-1 sm:grid-cols-2 sm:gap-1 pt-10">
                <?php foreach (getConstructors($constructors, $sorting) as $team) : ?>
                    <?php
                    ...
                    <article class="grid justify-items-center mb-20 sm:text-xs">
                        ...
                        <div class="flex flex-col items-center justify-center justify-items-center">
                            ...
                            <p class="sm:text-lg text-sm"><?php echo "<b>Temporadas</b>: " . $team['seasons']; ?></p>
                            ...
                            <p class="sm:text-lg text-sm"><?php echo "<b>Pilotos Campeões</b>: " . $team['driversChampions']; ?></p>
                            ...
                            <p class="sm:text-lg text-sm"><?php echo "<b>Última corrida</b>: " . $team['lastEntry']; ?></p>
